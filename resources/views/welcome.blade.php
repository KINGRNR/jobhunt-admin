                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            ...
                            <div class="header-search py-3 py-lg-0">
                                ...
                                <div id="kt_header_search" class="d-flex align-items-center"
                                    ...
                                    <!--begin::Form-->
                                    <form data-kt-search-element="form" class="w-100 position-relative me-3"
                                        autocomplete="off">
                            ...
                            <div class="d-flex align-items-center py-3 py-lg-0">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade" id="kt_topbar_notifications_1"
                                                ...
                                                <div class="py-3 text-center border-top">
                                                    <a href="../../demo9/dist/pages/profile/activity.html"
                                ...
                                <div class="me-3">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="../../demo9/dist/pages/projects/list.html"
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-5">
                                            <a href="../../demo9/dist/authentication/flows/basic/sign-in.html"
                                            ...
                                            <div class="menu-content px-5">
                                                <label
                                                    ...
                                                    <input class="form-check-input w-30px h-20px" type="checkbox"
                                                        ...
                                                        data-kt-url="../../demo9/dist/index.html" />
                                    ...
                                    <div class="card-header align-items-center border-0 mt-4">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                data-kt-menu="true" id="kt_menu_614859a20cbdc">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <div>
                                                            <select class="form-select form-select-solid"
                                                                ...
                                                                data-dropdown-parent="#kt_menu_614859a20cbdc"
                            ...
                            <div class="col-xl-8 ps-xl-12">
                                ...
                                <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-primary mb-5 mb-xl-8"
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-center">
                                        ...
                                        <!--begin::Action-->
                                        <div class="m-0">
                                            <a href='#' class="btn btn-success fw-bold px-6 py-3"
                                                        ...
                                                        <div class="d-flex align-items-center me-2">
                                                            ...
                                                            <div>
                                                                <a href="#"
                                                                    class="fs-6 text-gray-800 text-hover-primary fw-bolder">Top
                                                                    Sales</a>
                                                                <div class="fs-7 text-muted fw-bold mt-1">PitStop
                                                                    Emails</div>
                                                            </div>
                                                            <!--end::Title-->
                                                        </div>
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none rounded-0">
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo9/dist/pages/profile/activity.html" class="btn btn-bg-body text-primary">View All
                    Activities
                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
