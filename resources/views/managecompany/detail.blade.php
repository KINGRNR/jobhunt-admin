            ...
            <div class="card-header py-4">
                ...
                <div class="card-toolbar">
                    <div class="d-flex gap-4">
                        <button class="btn btn-danger btn-rejacc" data-bs-toggle="modal" data-bs-target="#modal_reject">Reject</button>
                        <button class="btn btn-success btn-rejacc" condition?="1" msg="Halo! Company request anda sudah kami terima, Selamat memakai full fitur yang kami sediakan!" onclick="accCompany(this)">Approve</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal-dialog modal-dialog-centered mw-650px" id="modal_form">
    <div class="modal-content">
        ...
        <form action="javascript:rejectCompany()" method="post" id="formReject" name="formReject" autocomplete="off"
            ...
            <div class="card card-bordered">
                <div class="card-body">
                    ...
                    <input type="hidden" name="msg" id="msg" value="Halo! Mohon maaf permintaan pendaftaran company anda kami tolak, untuk alasan terkait ada di bawah!">
