        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
            ...
            <tbody class="fw-bold text-gray-600">
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 1386</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 1323</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8673</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 6192</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 1952</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 9921</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3551</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 8192</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4888</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="visa">
                    <img src="assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 2418</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="mastercard">
                    <img src="assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 8991</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
                ...
                <tr>
                    ...
                    <!--begin::Name=-->
                    <td>
                        <a href="../../demo9/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
                    </td>
                    <!--end::Name=-->
                    <!--begin::Email=-->
                    <td>
                    ...
                    <!--begin::Payment method=-->
                    <td data-filter="american_express">
                    <img src="assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 3766</td>
                    <!--end::Payment method=-->
                    <!--begin::Date=-->
...
<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../demo9/dist/apps/customers/list.html">
                <!--begin::Modal header-->
