                ...
                <div class="tab-content px-5 px-xxl-10">
                        ...
                        <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                            ...
                            <div class="card-header align-items-center border-0">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6148511ce5735">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6148511ce5735" data-allow-clear="true">
                                                        <option></option>
                    ...
                    <div class="tab-pane fade show active" id="kt_sidebar_tab_3" role="tabpanel">
                        ...
                        <div class="card card-flush card-p-0 shadow-none bg-transparent mb-10">
                            ...
                            <div class="card-header align-items-center border-0">
                                <!--begin::Title-->
                                <h3 class="card-title fw-bolder text-white fs-3">Total Registered</h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <!--end::Title-->
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="sidebar-border-dashed d-flex flex-column justify-content-center rounded p-3 p-xxl-5">
                                            <!--begin::Value-->
                                            <div class="text-white fs-2 fs-xxl-2x fw-bolder mb-1" data-kt-countup="true" data-kt-countup-value="2000" data-kt-countup-prefix="">0</div>
                                            <!--begin::Value-->
                                            <!--begin::Label-->
                                            <div class="sidebar-text-muted fs-6 fw-bold">Total Account Users</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="sidebar-border-dashed d-flex flex-column justify-content-center rounded p-3 p-xxl-5">
                                            <!--begin::Value-->
                                            <div class="text-white fs-2 fs-xxl-2x fw-bolder mb-1" data-kt-countup="true" data-kt-countup-value="1589" data-kt-countup-prefix="">0</div>
                                            <!--begin::Value-->
                                            <!--begin::Label-->
                                            <div class="sidebar-text-muted fs-6 fw-bold">Total Applicants</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="sidebar-border-dashed d-flex flex-column justify-content-center rounded p-3 p-xxl-5">
                                            <!--begin::Value-->
                                            <div class="text-white fs-2 fs-xxl-2x fw-bolder mb-1" data-kt-countup="true" data-kt-countup-value="200" data-kt-countup-prefix="">0</div>
                                            <!--begin::Value-->
                                            <!--begin::Label-->
                                            <div class="sidebar-text-muted fs-6 fw-bold">Total Company</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="sidebar-border-dashed d-flex flex-column justify-content-center rounded p-3 p-xxl-5">
                                            ...
                                            <!--begin::Value-->
                                            <!--begin::Label-->
                                            <div class="sidebar-text-muted fs-6 fw-bold">Accepted Company</div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Item-->
                                    </div>
                        ...
                        <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                            ...
                            <div class="card-header align-items-center">
                                <!--begin::Title-->
                                <h3 class="card-title fw-bolder text-white fs-3">Listed Users</h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <!--end::Title-->
                            </div>
                            <!--end::Header-->
                            <!--begin::Body-->
                            <div class="card-body" id="list_user">
                                <!--begin::Item-->
                                <div class="d-flex flex-nowrap align-items-center mb-7">
                                    <!--begin::Image-->
                                    <div class="symbol symbol-40px symbol-2by3 me-4">
                        ...
                        <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                            ...
                            <div class="card-header align-items-center border-0">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6148511ce78d2">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                            <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                        </div>
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6148511ce78d2" data-allow-clear="true">
                                                        <option></option>
                                                        <option value="1">Approved</option>
                                                        <option value="2">Pending</option>
                                                        <option value="2">In Process</option>
                        ...
                        <div class="card card-flush card-p-0 shadow-none bg-transparent mb-5">
                            ...
                            <div class="card-header align-items-center border-0">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <!--begin::Menu 1-->
                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6148511ce855e">
                                        <!--begin::Header-->
                                        <div class="px-7 py-5">
                                            <div class="fs-5 text-dark fw-bolder">Filter Options</div>
                                        </div>
                                        ...
                                        <div class="px-7 py-5">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <!--begin::Input-->
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_6148511ce855e" data-allow-clear="true">
                                                        <option></option>
                                                        <option value="1">Approved</option>
                                                        <option value="2">Pending</option>
                                                        <option value="2">In Process</option>
...
@include('layouts.rightsidebarscript')