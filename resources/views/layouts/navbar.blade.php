    ...
    <div class="container d-flex align-items-center justify-content-between" id="kt_header_container">
        ...
        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-5 pb-lg-0"
            ...
            <h1 class="d-flex flex-column text-dark fw-bolder my-0 fs-1">Hello,
                {{ auth()->user()->name }}!
                <small class="text-muted fs-6 fw-bold pt-1" id="get_breadcumbs"></small>
            </h1>
            <!--end::Heading-->
        </div>
        <!--end::Page title=-->
...
-->
            ...
            <div class="d-flex align-items-center ms-3 ms-lg-4">
                <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline btn-outline-secondary w-40px h-40px position-relative pulse pulse-success"
