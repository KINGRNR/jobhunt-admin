            ...
            <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
                ...
                <div class="card shadow-none rounded-0">
                                    ...
                                    <div class="timeline-content mb-10 mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-bold mb-2">Task
                                                ...
                                                with
                                                <a href="#" class="text-primary fw-bolder me-1">#45890</a>in
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="overflow-auto pb-5">
                                                ...
                                                <div class="d-flex align-items-center mt-1 fs-6">
                                                    ...
                                                    <!--end::Info-->
                                                    <!--begin::User-->
                                                    <a href="#" class="text-primary fw-bolder me-1">Alice
                                                        Tan</a>
                                                    <!--end::User-->
                                                </div>
                                                <!--end::Wrapper-->
                    ...
                    <div class="card-footer py-5 text-center" id="kt_activities_footer">
                        <a href="../../demo3/dist/pages/profile/activity.html"
                                                            ...
                                                            <span class="d-flex align-items-center me-2">
                                                                ...
                                                                <span class="d-flex flex-column">
                                                                    <span class="fw-bolder fs-6">Quick Online
                                                                        Courses</span>
                                                                    <span class="fs-7 text-muted">Creating a clear
                                                                        text structure is just one SEO</span>
                                                                </span>
                                                                <!--end:Info-->
                                                            </span>
                                                            <!--end:Label-->
                                                            ...
                                                            <span class="d-flex align-items-center me-2">
                                                                ...
                                                                <span class="d-flex flex-column">
                                                                    <span class="fw-bolder fs-6">Face to Face
                                                                        Discussions</span>
                                                                    <span class="fs-7 text-muted">Creating a clear
                                                                        text structure is just one aspect</span>
                                                                </span>
                                                                <!--end:Info-->
                                                            </span>
                                                            <!--end:Label-->
                                                            ...
                                                            <span class="d-flex align-items-center me-2">
                                                                ...
                                                                <span class="d-flex flex-column">
                                                                    <span class="fw-bolder fs-6">Full Intro
                                                                        Training</span>
                                                                    <span class="fs-7 text-muted">Creating a clear
                                                                        text structure copywriting</span>
                                                                </span>
                                                                <!--end:Info-->
                                                            </span>
                                                            <!--end:Label-->
                                        ...
                                        <div data-kt-stepper-element="content">
                                            <div class="w-100 text-center">
                                                ...
                                                <div class="text-center px-4 py-15">
                                                    <img src="assets/media/illustrations/dozzy-1/9.png"
